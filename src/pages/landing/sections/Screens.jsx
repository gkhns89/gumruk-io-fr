...
const TABS = [
  {
    ...
    rows: [
      ["IM-2026-0418", "Anadolu Tekstil A.Ş.", "İthalat", { text: "Beyanname tescil", tone: "blue" }, "12.08.2026"],
      ["IM-2026-0417", "Marmara Kimya Ltd.", "İthalat", { text: "Muayene", tone: "amber" }, "11.08.2026"],
      ["EX-2026-0231", "Ege Makine San.", "İhracat", { text: "Yüklendi", tone: "sky" }, "11.08.2026"],
      ["IM-2026-0415", "Toros Gıda A.Ş.", "İthalat", { text: "Teslim edildi", tone: "green" }, "08.08.2026"],
      ["EX-2026-0229", "Konya Otomotiv Ltd.", "İhracat", { text: "Evrak bekleniyor", tone: "gray" }, "07.08.2026"],
    ],
  },
  {
    id: "antrepo",
    ...
    rows: [
      ["26341200AN000412", "Anadolu Tekstil A.Ş.", "24.07.2026", { text: "38 gün", tone: "green" }, "Antrepoda"],
      ["26341200AN000408", "Toros Gıda A.Ş.", "02.07.2026", { text: "12 gün", tone: "amber" }, "Antrepoda"],
      ["26341200AN000401", "Marmara Kimya Ltd.", "18.06.2026", { text: "4 gün", tone: "red" }, "Antrepoda"],
      ["26341200AN000396", "Ege Makine San.", "05.06.2026", { text: "—", tone: "gray" }, "İşleme aktarıldı"],
    ],
  },
  {
    id: "kurye",
    ...
    rows: [
      ...
      ["Ayşe K.", "Ofis → Anadolu Tekstil", "Orijinal konşimento", "Elden", { text: "Yolda", tone: "blue" }],
      ["Kargo", "Ofis → Ege Makine", "Fatura seti", "Kargo", { text: "Yolda", tone: "blue" }],
